...
black_Pineapple = Recipe.create(name:"Pineapple Salad with Sweet Rum Drizzle", image:"https://www.internationalcuisine.com/wp-content/uploads/2014/05/Antigua-pineapple-salad-1024x685.jpg",description: "Antigua is known for its delightful and juicy black pineapple. The simple salad incorporates Antigua's lovely and juicy black pineapple. Add incredible flavor to the pineapple with honey and a drizzle of rum; serve them in boats for a pleasant tropical feel.",instruction:["Cut the pineapple in ½ the long way and then into quarters.","Cut out the core and cut the pineapple into chucks, reserving the shell for serving.","In a bowl, Whisk together the honey and dark rum","Add in pineapple pieces and coat well.","Spoon the coated pineapple pieces into the shells and serve",],cooking_time: "10 mins", cuisine: "Antiguan")

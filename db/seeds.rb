...
hawaiian_Island_Fried_Rice = Recipe.create(name: "Hawaiian Island fried Rice", image: "https://savoryspicerack.com/hawaiian-island-style-fried-rice/", description: "Essentially, fried rice made with whatever leftovers you have in your fridge; traditionally, proteins made with this would be Spam, Portuguese sausage, and char siu.", cooking_time: "25 min", servings: 7, cuisine: "Hawaiian")
...
rourou = Recipe.create(name: "Rourou", image:"http://thegentlemansplate.com/fijian-roro-recipe/",description: "Rourou is a traditional Fijian dish prepared from taro leaves stewed in coconut milk. The simple Rourou is usually served either as a soup or a side dish in balls form accompanying various fish or chicken dishes and boiled cassava.", cooking_time: "35 mins", servings: 2, cuisine: "Fijian")
...
purini = Recipe.create(name: "Purini", image:"https://www.instagram.com/p/CWXUarxvkkX/?utm_source=ig_embed&ig_rid=55445084-7ec4-4f5a-953c-daef80546d1b",description: "This is a Typical Fijian dessert the main elements include cassava starch, brown sugar and coconut cream.",cooking_time: "1 hrs 30 mins", servings: 10, cuisine:"Fijian" )
...
lawar = Recipe.create(name:"Lawar", image:"https://img.theculturetrip.com/1440x/smart/wp-content/uploads/2021/07/kkc71c.jpg",description: "Lawar is made by mixing chopped meat with various green vegetables and grated coconut. As for the meat, the choices are beef, chicken, duck, pork, turtle, or a combination of those. Balinese know two types of lawar: red and white. The red gets its color from animal blood added to the mixture, which adds a particular savory flavor. White lawar, on the other hand, doesn’t contain blood and often substitutes meat with jackfruit.", cooking_time: "60 mins", servings: 4, cuisine: "Balinese")
